...
using Movies.Core.DependencyResolvers;
using Movies.Core.Extensions;
using Movies.Core.Utilities.IoC;
using Movies.Core.Utilities.Security.Encyption;
...
namespace Movies.WebAPI
{
    ...
    options.SerializerSettings.ReferenceLoopHandling = Newtonsoft.Json.ReferenceLoopHandling.Ignore
            ...
            services.AddDbContext<MovieContext>(x => x.UseSqlServer(Configuration.GetConnectionString("ConnStr")));

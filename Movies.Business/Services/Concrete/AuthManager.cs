...
using Movies.Core.Utilities.Security.Hashing;
...
namespace Movies.Business.Services.Concrete
{
    public class AuthManager : IAuthService
    {
        ...
        public IDataResult<User> Register(UserForRegisterDto userForRegisterDto, string password)
        {
            ...
            return new SuccessDataResult<User>(user, Messages.UsersAdded);
        }
        ...
        public IDataResult<AccessToken> CreateAccessToken(User user)
        {
            ...
            return new SuccessDataResult<AccessToken>(accessToken, Messages.AccessTokenAdded);
        }
    }
}
